...
// Paste these into your regions.ts array

  {
    ...
    tagline: "Where Every Road Leads to Wonder",
    description:
      "From the café-culture of Kasol to the last Indian village of Chitkul, from Triund's Dhauladhar views to Jalori Pass's forest trails — Himachal is India's most beloved mountain escape for every kind of traveller.",
    image: "/images/destinations/himachal.jpg",
    accent: "#3db89e",
    highlights: [
      "Snow-capped passes & alpine meadows",
      "River cafés, waterfalls & forest treks",
      "Budget backpacker to luxury stay options",
    ],
  ...
  },
  {
    ...
    region: "india",
    name: "Spiti Valley",
    tagline: "The Land Between the Sky and Earth",
    description:
      "Cold desert moonscapes, thousand-year-old monasteries, the world's highest post office, and roads that test every nerve — Spiti Valley is for those who seek India's most raw and remote Himalayan frontier.",
    image: "/images/destinations/spiti.jpg",
    accent: "#8e44ad",
    highlights: [
      "Key Monastery, Hikkim, Komic & Langza villages",
      "Chandratal Lake — camp under the Milky Way",
      "Bike expedition on India's most thrilling roads",
    ],
    bestMonths: "Jun – Oct (Summer), Dec – Feb (Winter)",
    startingPrice: 0,
    tripCount: 0,
    featured: true,
  },
  {
    ...
    description:
      "Char Dham's sacred circuit, Kedarnath's divine altar in the clouds, Kedarkantha's snow-trek summit, and Chopta's forest campsites — Uttarakhand blends pilgrimage, trekking, and pure mountain peace into one.",
    image: "/images/destinations/uttarakhand.jpg",
    accent: "#e07b3d",
    highlights: [
      "Char Dham & Kedarnath pilgrimage",
      "Kedarkantha — Uttarakhand's most loved winter trek",
  ...
  },
  {
    ...
    description:
      "Dawki's impossibly clear river, Double Decker Root Bridges deep in Cherrapunji's rainforest, Asia's cleanest village, and the world's wettest place — Meghalaya is the Northeast's most spectacular secret.",
    image: "/images/destinations/meghalaya.jpg",
    accent: "#27ae60",
    highlights: [
      "Dawki river — crystal-clear boat rides",
  ...
  },
  {
    ...
    description:
      "Shikara rides at dawn on Dal Lake, saffron fields of Pampore, the meadows of Gulmarg and Sonamarg, and a warmth of hospitality that stays with you forever — Kashmir is India's crown jewel, finally within reach.",
    image: "/images/destinations/kashmir.jpg",
    accent: "#4a90d9",
    highlights: [
      "Dal Lake houseboat & shikara sunrise",
      "Gulmarg cable car & snow activities",
      "Pahalgam, Betaab Valley & Aru Valley",
    ],
    bestMonths: "Apr – Jun, Sep – Nov, Dec – Feb (snow)",
    startingPrice: 0,
    tripCount: 0,
    featured: true,
  },
  {
    ...
    region: "india",
    name: "Rajasthan",
    tagline: "The Land of Kings & Golden Sands",
    description:
      "Desert camps at Sam Sand Dunes, the golden fort of Jaisalmer, Udaipur's lake palaces, Kumbhalgarh's 38-km wall, and folk music around a Rajasthani bonfire — the royal state delivers India at its most vivid.",
    image: "/images/destinations/rajasthan.jpg",
    accent: "#e07b3d",
    highlights: [
      "Jaisalmer Fort & Sam Sand Dunes camel safari",
      "Udaipur — City of Lakes & Kumbhalgarh Fort",
