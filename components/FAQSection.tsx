          ...
          <div style={{ maxWidth: 1000, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 28, position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <motion.a href="https://wa.me/919253289347" target="_blank" rel="noopener noreferrer"
                ...
                style={{ padding: '12px 24px', borderRadius: 999, background: 'rgba(37,211,102,0.12)', border: '1.5px solid rgba(37,211,102,0.35)', color: '#4de88e', fontFamily: '"Outfit",sans-serif', fontSize: 13, fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 7, letterSpacing: '0.02em' }}>
