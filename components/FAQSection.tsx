    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <line x1="6" y1="0" x2="6" y2="12" stroke={open ? '#fff' : C.sub} strokeWidth="1.8" strokeLinecap="round"/>
            <line x1="0" y1="6" x2="12" y2="6" stroke={open ? '#fff' : C.sub} strokeWidth="1.8" strokeLinecap="round"/>
          </motion.svg>
        </motion.div>
      </button>
        ...
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 'clamp(28px,4vw,40px)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 14 }}>
              <div style={{ height: 1, width: 28, background: `linear-gradient(to right,transparent,${'black'})` }}/>
              <span style={{ fontFamily: '"Montserrat",sans-serif', fontSize: 10, fontWeight: 700, color: 'black', letterSpacing: '0.26em', textTransform: 'uppercase' }}>FAQ</span>
              <div style={{ height: 1, width: 28, background: `linear-gradient(to left,transparent,${'black'})` }}/>
            </div>
            <h2 style={{ fontFamily: '"Inter",serif', fontWeight: 600, fontSize: 'clamp(24px,4vw,46px)', lineHeight: 1.08, color: C.sea, marginBottom: 14, letterSpacing: '-0.01em' }}>
              Find Your Answers <br/><span style={{ color: C.sea }}>Here.</span>
            </h2>
            <p style={{ fontFamily: '"Montserrat",sans-serif', fontWeight: 300, fontSize: 15, color: 'black', lineHeight: 1.75, maxWidth: 520, margin: '0 auto' }}>
