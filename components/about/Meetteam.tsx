...
const team: TeamMember[] = [
  {
    name: "Sarah Mitchell",
    role: "Founder & CEO",
    bio: "Sarah founded Kafira with a vision to create meaningful travel experiences that go beyond traditional tourism. Her passion for exploration and commitment to customer satisfaction continue to shape the company's journey.",
  ...
  },
  {
    ...
    bio: "James helps build and nurture the Kafira travel community, connecting like-minded travelers through stories, experiences, and shared adventures.",
    image: "/images/team/james-wilson.jpg",
    social: { linkedin: "https://linkedin.com/in/james-wilson", instagram: "https://instagram.com/james.wilson" },
  },
  {
    name: "Michael Anderson",
    role: "Customer Success Manager",
    bio: "Michael is dedicated to providing exceptional support before, during, and after every trip. He believes great service is the key to unforgettable travel experiences.",
