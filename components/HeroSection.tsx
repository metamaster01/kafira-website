...
// //   TrendingUp, Star, Globe, Award, Compass, ArrowRight,
// // } from 'lucide-react';

// // const STATS = [
// //   { value: '5000+',  label: 'Trips Crafted',   icon: Compass },
// //   { value: '98%',    label: 'Happy Travelers',  icon: Star    },
// //   { value: '120+',   label: 'Destinations',     icon: Globe   },
// //   { value: '12 Yrs', label: 'of Excellence',    icon: Award   },
// // ];
...
// //     else vid.addEventListener('canplay', playVideo, { once: true });
// //   }, []);
...
// //         }}
// //       >
// //         {/* fallback gradient — BEHIND video (z-index -1 relative) */}
// //         <div
// //           className="absolute inset-0"
// //           style={{
// //             zIndex: 0,
// //             background:
// //               'linear-gradient(125deg,#0d1a2e 0%,#1a100a 40%,#0a1a12 70%,#1a1408 100%)',
// //           }}
// //         />

// //         {/* ambient glow blobs — above fallback, below video */}
...
// //           background:'radial-gradient(circle,rgba(40,120,80,0.1) 0%,transparent 70%)',
// //           bottom:80,left:-80,
...
// //       }}/>
// //       {/* left → right: strong on left for text, fades right */}
// //       <div className="absolute inset-0" style={{
// //         zIndex:4,
// //         background:'linear-gradient(to right,rgba(10,8,6,0.88) 0%,rgba(10,8,6,0.42) 55%,rgba(10,8,6,0.05) 100%)',
// //       }}/>
// //       {/* bottom vignette */}
// //       <div className="absolute inset-0" style={{
// //         zIndex:4,
// //         background:'linear-gradient(to top,rgba(10,8,6,0.92) 0%,rgba(10,8,6,0.45) 25%,transparent 60%)',
// //       }}/>
// //       {/* top vignette (nav area) */}
// //       <div className="absolute inset-0" style={{
// //         zIndex:4,
// //         background:'linear-gradient(to bottom,rgba(10,8,6,0.60) 0%,transparent 20%)',
// //       }}/>

// //       {/* ══════════════════════════════════════════════════
// //            CONTENT — 50% left | 35% right | 15% breathing
// //          ══════════════════════════════════════════════════ */}
// //       <div
// //         className="relative h-full flex"
// //         style={{ zIndex:10, paddingTop:110 }}
// //       >
...
// //             }}/>
// //             <span style={{
// //               color:'#c9a84c',fontSize:11,letterSpacing:'0.22em',
...
// //           >
// //             Where Will<br/>
// //             <span className="gold-text font-display" style={{ fontStyle:'italic' }}>
// //               Your Story
// //             </span>{' '}Begin?
// //           </h1>
...
// //             }}
// //           >
// //             Handcrafted journeys across India and beyond.
// //             Every trip, a memory worth keeping.
// //           </p>
...
// //               {(['tours','destinations','custom'] as const).map(t => (
// //                 <button
// //                   key={t}
// //                   onClick={() => setTab(t)}
// //                   style={{
...
// //                     ...(tab === t
// //                       ? { background:'linear-gradient(135deg,#c9a84c,#8b6914)', color:'#0c0a08', border:'none' }
// //                       : { background:'rgba(245,240,232,0.07)', color:'rgba(245,240,232,0.5)', border:'1px solid rgba(245,240,232,0.1)' }
// //                     ),
// //                   }}
// //                 >{t}</button>
// //               ))}
...
// //             {/* search input — glass upgraded */}
// //             <div
// //               style={{
// //                 display:'flex',
// //                 alignItems:'stretch',
// //                 background: sFocus ? 'rgba(20,16,12,0.65)' : 'rgba(20,16,12,0.55)',
// //                 border:`1px solid ${sFocus ? 'rgba(201,168,76,0.35)' : 'rgba(255,255,255,0.08)'}`,
// //                 borderRadius:18,
...
// //                 maxWidth:580,
// //                 boxShadow: sFocus
// //                   ? '0 0 0 1px rgba(201,168,76,0.25), 0 12px 50px rgba(0,0,0,0.45)'
// //                   : '0 10px 40px rgba(0,0,0,0.35)',
// //                 transition:'all 0.3s ease',
// //               }}
// //             >
// //               <div style={{ display:'flex',alignItems:'center',padding:'0 14px',color:'#c9a84c' }}>
// //                 <MapPin size={17}/>
// //               </div>
// //               <input
// //                 type="text"
...
// //                   padding:'15px 0', color:'#f5f0e8',
// //                   fontFamily:'Outfit,sans-serif', fontSize:14,
// //                 }}
// //               />
// //               <div style={{ display:'flex',alignItems:'center',gap:6,padding:'0 14px',borderLeft:'1px solid rgba(255,255,255,0.06)' }}>
// //                 <Calendar size={13} style={{ color:'rgba(245,240,232,0.32)' }}/>
// //                 <span style={{ fontSize:13,fontFamily:'Outfit,sans-serif',color:'rgba(245,240,232,0.32)' }}>Any Date</span>
// //               </div>
// //               <div style={{ display:'flex',alignItems:'center',gap:6,padding:'0 14px',borderLeft:'1px solid rgba(255,255,255,0.06)' }}>
// //                 <Users size={13} style={{ color:'rgba(245,240,232,0.32)' }}/>
// //                 <span style={{ fontSize:13,fontFamily:'Outfit,sans-serif',color:'rgba(245,240,232,0.32)' }}>2 People</span>
// //               </div>
// //               <button
// //                 style={{
// //                   margin:7, padding:'0 20px', borderRadius:12,
// //                   background:'linear-gradient(135deg,#c9a84c,#8b6914)',
// //                   color:'#0c0a08', fontFamily:'Outfit,sans-serif', fontWeight:600,
...
// //                   (e.currentTarget as HTMLButtonElement).style.boxShadow='0 6px 22px rgba(201,168,76,0.4)';
// //                 }}
// //                 onMouseLeave={e => {
...
// //               <span style={{ fontSize:11,fontFamily:'Outfit,sans-serif',color:'rgba(245,240,232,0.38)' }}>Trending:</span>
// //               {TRENDING.map(t => (
// //                 <button
// //                   key={t}
// //                   onClick={() => setDest(t)}
...
// //             marginTop:28,
// //             opacity: ready ? 1 : 0,
// //             transition:'opacity 0.85s ease 0.6s',
// //           }}>
// //             <a
// //               href="#tours"
...
// //         {/* ── RIGHT 35% — premium floating stats ── */}
// //         <div
...
// //             gap:20,
// //             opacity: ready ? 1 : 0,
// //             transform: ready ? 'none' : 'translateX(28px)',
...
// //                   <div
// //                     className="font-display"
// //                     style={{ fontSize:26, fontWeight:800, color:'#f5f0e8', lineHeight:1 }}
// //                   >
// //                     {value}
// //                   </div>
// //                   <div style={{
// //                     fontSize:12, fontFamily:'Outfit,sans-serif',
// //                     color:'rgba(245,240,232,0.42)', marginTop:5, letterSpacing:'0.04em',
// //                   }}>
// //                     {label}
// //                   </div>
// //                 </div>
...
// //               {i < STATS.length - 1 && (
// //                 <div style={{
// //                   width:1, height:20, marginRight:40,
// //                   background:'linear-gradient(to bottom,rgba(201,168,76,0.2),rgba(201,168,76,0.04))',
// //                 }}/>
// //               )}
// //             </div>
// //           ))}
...
// //           opacity: ready && scrollY < 60 ? 0.5 : 0,
...
// //           color:'rgba(245,240,232,0.45)', letterSpacing:'0.2em', textTransform:'uppercase',
// //         }}>Scroll</span>
// //         <div style={{
...
// //         }}>
// //           <div style={{
// //             width:4, height:8, borderRadius:2, background:'#c9a84c',
...
//     scrollY / (typeof window !== "undefined" ? window.innerHeight : 800),
//     1,
//   );
...
//             borderRadius: "50%",
//             background:
//               "radial-gradient(circle,rgba(40,120,80,0.09) 0%,transparent 70%)",
//             bottom: 60,
//             left: -70,
//             animation: "float 12s ease-in-out infinite reverse",
//             pointerEvents: "none",
...
//       {/* ══ GRADIENT MASKS ══ */}
//       {/* <div className="absolute inset-0" style={{ zIndex:3, background:'rgba(10,8,6,0.38)' }}/
//       <div className="absolute inset-0" style={{
//         zIndex:4,
//         background: isMobile
//           ? 'rgba(10,8,6,0.55)'
//           : 'linear-gradient(to right,rgba(10,8,6,0.88) 0%,rgba(10,8,6,0.42) 55%,rgba(10,8,6,0.05) 100%)',
//       }}/>
//       <div className="absolute inset-0" style={{ zIndex:4, background:'linear-gradient(to top,rgba(10,8,6,0.95) 0%,rgba(10,8,6,0.45) 25%,transparent 60%)' }}/>
//       <div className="absolute inset-0" style={{ zIndex:4, background:'linear-gradient(to bottom,rgba(10,8,6,0.65) 0%,transparent 20%)' }}/> */}

//       {/* ══ GRADIENT MASKS (optimized) ══ */}

//       {/* Base soft dark layer (overall readability) */}
//       <div
//         className="absolute inset-0"
//         style={{
//           zIndex: 2,
...
//       {/* Left → Right fade (main readability layer) */}
//       <div
//         className="absolute inset-0"
//         style={{
//           zIndex: 3,
//           background: isMobile
//             ? "rgba(10,8,6,0.45)"
//             : "linear-gradient(to right, rgba(10,8,6,0.75) 0%, rgba(10,8,6,0.35) 55%, rgba(10,8,6,0.08) 100%)",
//         }}
//       />

//       {/* Bottom gradient (for text contrast — keep slightly stronger) */}
//       <div
//         className="absolute inset-0"
//         style={{
//           zIndex: 3,
//           background:
//             "linear-gradient(to top, rgba(10,8,6,0.65) 0%, rgba(10,8,6,0.25) 30%, transparent 70%)",
//         }}
//       />

//       {/* Top gradient (very light — only for navbar visibility) */}
//       <div
//         className="absolute inset-0"
//         style={{
//           zIndex: 3,
//           background:
//             "linear-gradient(to bottom, rgba(10,8,6,0.25) 0%, transparent 30%)",
//         }}
//       />
//       {/* ══ CONTENT ══ */}
//       <div
...
//           {/* subline — hide on very small screens */}
//           <p
//             style={{
//               fontFamily: "Outfit,sans-serif",
//               fontSize: subSize,
...
//               transform: ready ? "none" : "translateY(18px)",
//               transition:
//                 "opacity 0.85s ease 0.32s, transform 0.85s ease 0.32s",
//               display: isMobile ? undefined : undefined,
//             }}
//           >
//             {isMobile
//               ? "Handcrafted journeys across India and beyond."
//               : "Handcrafted journeys across India and beyond. Every trip, a memory worth keeping."}
//           </p>
...
//               transform: ready ? "none" : "translateY(18px)",
//               transition:
//                 "opacity 0.85s ease 0.44s, transform 0.85s ease 0.44s",
//             }}
//           >
//             {/* tabs — all three on desktop, just two on mobile */}
//             <div
//               style={{
//                 display: "flex",
//                 gap: 6,
...
//             >
//               {(
//                 ["tours", "destinations", ...(isMobile ? [] : ["custom"])] as (
//                   | "tours"
//                   | "destinations"
//                   | "custom"
//                 )[]
...
//                       ? "rgba(20,16,12,0.7)"
//                       : "rgba(20,16,12,0.55)",
//                     border: `1px solid ${sFocus ? "rgba(201,168,76,0.4)" : "rgba(255,255,255,0.1)"}`,
//                     borderRadius: 14,
//                     backdropFilter: "blur(24px)",
//                     overflow: "hidden",
//                     marginBottom: 8,
//                     boxShadow: sFocus
//                       ? "0 0 0 1px rgba(201,168,76,0.2),0 8px 30px rgba(0,0,0,0.4)"
...
//         {/* ── RIGHT: stats — desktop vertical stack / mobile bottom strip ── */}
//         {!isMobile ? (
...
//                       marginRight: 36,
//                       background:
//                         "linear-gradient(to bottom,rgba(201,168,76,0.2),rgba(201,168,76,0.03))",
//                     }}
//                   />
//                 )}
//               </div>
...
//           </div>
//         ) : (
//           /* MOBILE: horizontal stats strip at bottom */
//           <div
//             style={{
//               position: "absolute",
//               bottom: 0,
...
//               background:
//                 "linear-gradient(to top,rgba(10,8,6,0.92) 0%,rgba(10,8,6,0.6) 70%,transparent 100%)",
//               opacity: ready ? 1 : 0,
...
//                   <Icon
//                     size={14}
//                     style={{ color: "#c9a84c", marginBottom: 4 }}
//                   />
//                   <div
//                     className="font-display"
//                     style={{
