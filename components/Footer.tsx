...
//     title: 'Explore',
//     links: [
//       { label: 'All Destinations',    href: '#all-trips' },
//       { label: 'Rajasthan',           href: '#all-trips' },
//       { label: 'Kerala Backwaters',   href: '#all-trips' },
//       { label: 'Himalayan Escapes',   href: '#all-trips' },
//       { label: 'Goa & Beaches',       href: '#all-trips' },
//       { label: 'International',       href: '#all-trips' },
//     ],
//   },
//   {
//     title: 'Experience',
  ...
  return (
    <footer style={{ background: C.darkBg, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {/* top glow line */}
        <div style={{ position: 'absolute', top: 0, left: '8%', right: '8%', height: 1, background: `linear-gradient(to right,transparent,${C.sea},transparent)`, opacity: 0.5 }}/>
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '56px 40px 44px', position: 'relative', zIndex: 1 }}>
        ...
        {/* ── TRUST BADGES ROW ── */}
        <div ref={badgeRef} style={{ opacity: 0, display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 14 }}>
          {[
            { icon: '🏆', label: 'Best Travel Agency', sub: 'India Travel Awards 2024' },
            { icon: '⭐', label: '4.9 / 5 Rating',     sub: '12,400+ verified reviews' },
            { icon: '✅', label: 'Govt. Recognized',   sub: 'Ministry of Tourism, India' },
